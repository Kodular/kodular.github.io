...
<?php include "../assets/templates/header.php"; ?>
	...
	<div class="centre-arrangement">
	  <h1>Documentation</h1>
	  <p>We understand that creating your app can sometimes be a struggle. You may not know how a component works, or don't know what a certain block does? Don't worry! We've put together some very detailed and helpful docs to help you understand.</p>
	  <br>
	  <p>There are a few different block types for each component. These are <b>Events</b>, <b>Methods</b> and <b>Properties</b>. To read more about each of these for each component, hover over them.</p>
	  <p>Properties in <i>italics</i> are Designer Only properties, which means they cannot be changed using blocks.</p>
	  <br>
