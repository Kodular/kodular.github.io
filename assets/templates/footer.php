        ...
        <div class="media-container-row content mbr-white">
            ...
            <div class="col-md-4 col-sm-8">
                ...
                <p class="mbr-text mbr-fonts-style display-7">
                    We are working very hard to bring a stable version<br>You can talk to us to grant you access to the beta</p>
            </div>
                ...
                <div class="mb-5" data-form-type="formoid">
                    ...
                    <form class="mbr-form" action="#" method="post" data-form-type="formoid">
                        ...
                        <div class="mbr-subscribe mbr-subscribe-dark input-group">
                            ...
                            <button type="submit" class="btn btn-sm btn-primary display-4">Subscribe</button>
                            </span>
                        </div>
                    </form>
                </div>
